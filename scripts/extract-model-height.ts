...
function main() {
    const storageHandle = casclib.openStorageSync("D:\\Games\\Warcraft III")
    try {
        ...
        fs.writeFileSync("unitModelHeightData.json", JSON.stringify(Object.fromEntries(modelHeights), null, 2))
    } finally {
